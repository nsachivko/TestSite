...
const PostDetails = ({ dynamicPageItem, item }) => {
  ...
  let postsString = replaceGlobally(
    fields.content,
    "<h2>",
    '<h2 className="mt-15">'
  )
  postsString = replaceGlobally(
    postsString,
    "<img",
    '<img className="rounded-md object-cover h-96 w-192 mr-5"'
  )
  ...
  return (
    <div className="flex flex-col justify-center items-center ">
      <div className="max-w-5xl">{parse(postsString)}</div>
    </div>
  )
}
